...
<nav className="navbar navbar-dark bg-dark mb-5">
    ...
    <div className="navbar-expand mr-auto">
      <div className="navbar-nav">
        <a className="nav-item nav-link active" href="/home" hrefActive="active">Home</a>
        <a className="nav-item nav-link" href="/admin"  hrefActive="active">Admin</a>
        <a className="nav-item nav-link" href="/product" hrefActive="active">Products</a>
      </div>
    </div>
